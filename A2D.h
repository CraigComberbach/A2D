 ...
 * @return 1 = Channel was updated successfully, 0 = Value out of range, no changes were made
 */
 int A2D_Advanced_Channel_Settings(int channel, enum RESOLUTION desiredResolutionIncrease, int numberOfAverages, int (*formatFunction)(int), void (*preFunction)(int), void (*postFunction)(int), void (*finishedFunction)(int), int (*inspectionFunction)(int, volatile unsigned int *, int), enum A2D_SAMPLE_SIZE sampleSize);
